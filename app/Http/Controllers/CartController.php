...
class CartController extends Controller
{
    ...
    public function addToCart(Request $request)
    {
        ...
        if (Cart::count() > 0) {
            ...
            if ($productAlreadyExist == false) {
                ...
                $status = true;
                $message = '<strong>' . $product->title . '</strong> added in your cart sucessfully.';
            ...
            $status = true;
            $message = $product->title . ' added in your cart sucessfully.';
            session()->flash('success', $message);
        }
    ...
    public function updateCart(Request $request)
    {
        ...
        if ($product->track_qty == 'Yes') {
            ...
            if ($qty <= $product->qty) {
                ...
                $message = 'Requested Product(' . $qty . ') not available in stock.';
                $status = false;
    ...
    public function deleteItem(Request $request)
    {
        ...
        if ($itemInfo == null) {
            $erroMessage = 'Item not found in cart';
    ...
    public function processCheckout(Request $request)
    {
        ...
        // $customeAddress = CustomerAddress::find()
