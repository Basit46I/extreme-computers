                            ...
                            <div class="card-body p-4">
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" value="{{ !empty($address) ? $address->first_name : '' }}"
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" value="{{ !empty($address) ? $address->last_name : '' }}"
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <label for="email">Email</label>
                                        <input type="text" value="{{ !empty($address) ? $address->email : '' }}"
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" value="{{ !empty($address) ? $address->mobile : '' }}"
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" value="{{ !empty($address) ? $address->apartment : '' }}"
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" value="{{ !empty($address) ? $address->state : '' }}"
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" value="{{ !empty($address) ? $address->zip : '' }}"
