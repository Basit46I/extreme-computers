                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <textarea name="description" id="description" cols="50" rows="20" class="summernote"
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <textarea name="shipping_returns" id="shipping_returns" cols="50" rows="20" class="summernote"
                                ...
                                @foreach ($productImages as $image)
                                    <div class="col-md-3" id="image-row-{{ $image->id }}">
                                        <div class="card">
                                            ...
                                            <img src="{{ url('uploads/product/small/' . $image->image) }}"
