...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="{{ asset('front-assets/images/favicon.png') }}">


    <link rel="stylesheet" href="{{ url('admin-assets/plugins/dropzone/min/dropzone.css') }}">
    <link rel="stylesheet" href="{{ url('admin-assets/plugins/summernote/summernote.min.css') }}">
    <link rel="stylesheet" href="{{ url('admin-assets/plugins/select2/css/select2.min.css') }}">
    <link rel="stylesheet" href="{{ url('admin-assets/css/datetimepicker.css') }}">
...
<body class="hold-transition sidebar-mini">
    ...
    <!-- AdminLTE App -->
    <script src="{{ url('admin-assets/js/adminlte.min.js') }}"></script>
    ...
    <script src="{{ url('admin-assets/js/datetimepicker.js') }}"></script>

    <!-- AdminLTE for demo purposes -->
    <script src="{{ url('admin-assets/js/demo.js') }}"></script>


    <script src="{{ url('admin-assets/plugins/dropzone/min/dropzone.min.js') }}"></script>
